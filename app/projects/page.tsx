    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 py-32">
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex items-center gap-8 mb-16">
          ...
          >
            <ArrowLeft size={20} className="text-violet-600 dark:text-violet-400 group-hover:-translate-x-1 transition-transform duration-300" />
            ...
            >
              ...
              <div className="p-8 relative">
                ...
                <div className="flex gap-4">
                  ...
                  >
                    <Github size={18} className="group-hover:scale-110 transition-transform duration-300 text-black dark:text-black" />
                    <span className="text-black dark:text-black">Source Code</span>
                  </a>
                </div>
              </div>
            </motion.div>
